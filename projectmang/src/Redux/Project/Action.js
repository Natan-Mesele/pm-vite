  ...
  export const inviteToProject =
    ...
    async (dispatch) => {
      ...
      try {
        ...
        console.log("error", error);
        dispatch({ type: INVITE_TO_PROJECT_FAILURE, payload: error });
      }
    };
  ...
  export const acceptInvitation =
    ...
    async (dispatch) => {
      ...
      try {
        ...
        console.log("iaccept invitation", data);
